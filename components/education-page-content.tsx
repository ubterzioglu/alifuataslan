  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 md:py-16">
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-9">
        <h1 className="font-[var(--font-serif)] text-3xl text-[var(--color-navy)] md:text-4xl">Egitimler</h1>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--color-slate)] md:text-base">
          Finansal Gunluk egitim modulu yakinda yayinda olacak. Icerikler, teorik temelleri sade bir dille aktaran ve pratik dusunce disiplini kazandirmayi hedefleyen moduler bir yapiyla planlanmaktadir.
        </p>
        ...
        <div className="mt-8 rounded-xl border border-dashed border-slate-300 p-5">
          <p className="text-sm text-[var(--color-slate)]">Yeni egitimleri e-posta ile duymak icin yakinda duyuru alani eklenecektir.</p>
        </div>
        ...
        <Link href="/iletisim" className="focus-ring mt-6 inline-flex rounded-md bg-[var(--color-navy)] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-95">
          Haberdar Olmak Icin Iletisime Gec
        </Link>
      </div>
    </section>
  );
